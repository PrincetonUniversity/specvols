...
%       1: The naive DFT implementation, 'nudft',
...
%          'finufft'.
%    For example, the default library code order, [4 3 2 1] specifies to first
%    try the 'finufft' library, then 'chemnitz', then 'cims', and if none of
%    these work, 'nudft'.
%
% See also
