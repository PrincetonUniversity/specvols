...
N = 8;
%I use odd ns to help make it clear when matrices involve voxels in a
%volume, or individual volumes/pictures/coordinates/whatever
n = 2^11 - 1;
...
% 
% [eigs_est_raw, lambdas_est_raw] = eig(make_symmat(reshape(covar_est,[N^3 N^3])));
% 
