root_dir = fullfile(pkg_root(), 'data', 'frost_ribosome');

star_file = fullfile(root_dir, '_it050_data.star');

star_opt = struct();
star_opt.pixel_size = 1.22;
...
src_cropped = crop_src(src_orig, [60 60], [359 359]);
