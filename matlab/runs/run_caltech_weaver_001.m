root_dir = fullfile(pkg_root(), 'data', 'caltech_weaver');

star_file = fullfile(root_dir, 'particles.star');

star_opt = struct();
star_opt.pixel_size = 0.8315;
...
src_cropped = crop_src(src_orig, [41 41], [265 265]);
