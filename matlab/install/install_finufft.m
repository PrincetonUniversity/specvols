...
%    fftw_location: The location of the FFTW3 package needed to compile
%       FINUFFT. By default, the location is 'extern/fftw3'.
%
% Description
    ...
    if exist(filepath, 'file') && get_file_size(filepath) > 0
        ...
        try
            ...
            if get_file_size(filepath) == 0
                e = MException('cov3d:install_finufft:DownloadFailed');
                throw(e);
            end
        catch
            fprintf('Failed.\n');
